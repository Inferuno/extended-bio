...
## How it was made
The design of this was made from an AI mockup, the design itself is my weakest point and I'll be designing the next project I create without the help of an AI.

## License
See [LICENSE](LICENSE), no art is specifically mine, but the code is.

## Credits
Pfp: Jinhsi concept art, © Kuro Games. Used for personal identification only, not covered by this repo's license.

Brand icons: used per each owner's brand guidelines, check [assets/brand/README.md](assets/brand/README.md) for more details.